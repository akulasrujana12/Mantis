...
final class CropAuxiliaryIndicatorView: UIView, CropAuxiliaryIndicatorViewProtocol {
    ...
    override func draw(_ rect: CGRect) {
        ...
        // Adapt ratios based on aspect ratio
        let aspectRatio = w / h
        var topOfHeadRatio: CGFloat = 0.05
        var eyesRatio: CGFloat = 0.35
        var chinRatio: CGFloat = 0.75
        ...
        drawDottedLine(yRatio: topOfHeadRatio, label: "Top of Head")
        drawDottedLine(yRatio: eyesRatio, label: "Eyes")
        drawDottedLine(yRatio: chinRatio, label: "Chin")
